    ...
    <div className="universal-hero-container" style={{ width: '100%', maxWidth: '1040px', margin: '0 auto', position: 'relative' }}>
      <style>{`
        ...
        .universal-dropzone-box.drag-over {
          ...
          box-shadow: 0 0 0 4px rgba(0, 0, 0, 0.05), 0 12px 30px -4px rgba(0, 0, 0, 0.1) !important;
        ...
        @keyframes pulseLockGlow {
          0% {
            box-shadow: 0 0 0 0 rgba(17, 24, 39, 0.2), 0 4px 16px rgba(0,0,0,0.04);
            border-color: #111827;
          }
          50% {
            box-shadow: 0 0 0 6px rgba(17, 24, 39, 0.1), 0 8px 24px rgba(0,0,0,0.08);
            border-color: #111827;
          }
          100% {
            box-shadow: 0 0 0 0 rgba(17, 24, 39, 0), 0 4px 16px rgba(0,0,0,0.04);
            border-color: #e2e8f0;
          }
        }
