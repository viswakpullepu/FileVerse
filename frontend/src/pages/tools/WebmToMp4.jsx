  ...
  return (
    <div className="tool-page" style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem' }}>
      ...
      <p style={{ marginTop: '1rem', color: '#666' }}>
        Convert WEBM videos to universally compatible MP4 format natively in your browser.
      </p>
      ...
      {!processedVideoUrl ? (
        <>
          ...
          >
            <p style={{ fontSize: '1.5rem' }}>{file ? file.name : 'Select WEBM File'}</p>
            <span style={{ fontSize: '1rem', color: '#888', display: 'block', marginTop: '1rem' }}>
              {file ? 'Click to change file' : 'or drop WEBM here'}
            </span>
            <input 
              id="file-upload" 
              type="file" 
