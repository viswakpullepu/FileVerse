  ...
  return (
    <div className="tool-page" style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem' }}>
      ...
      <p style={{ marginTop: '1rem', color: '#666' }}>
        Convert your PDF files to editable Word documents using our secure backend engine.
      </p>
      ...
      {!downloadUrl ? (
        <div style={{ marginTop: '2rem' }}>
          ...
          >
            <UploadCloud size={48} color="#e5322d" style={{ marginBottom: '1rem' }} />
          ...
          {errorMsg && <div style={{ color: 'red', marginTop: '1rem', textAlign: 'center', fontWeight: 'bold' }}>{errorMsg}</div>}
          ...
          {file && (
            <button 
              ...
              style={{ width: '100%', marginTop: '2rem', padding: '1rem', fontSize: '1.2rem', backgroundColor: '#e5322d', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.5rem' }}
            >
              <FileText size={20} />
        ...
        <div style={{ marginTop: '2rem', textAlign: 'center' }}>
          <div style={{ padding: '3rem', backgroundColor: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '12px', marginBottom: '2rem' }}>
            ...
            <p style={{ color: '#15803d', marginBottom: '2rem' }}>Your Word document is ready to download.</p>
            
            <a 
              href={downloadUrl} 
              download={`converted_${file.name.replace('.pdf', '')}.docx`} 
              className="btn"
