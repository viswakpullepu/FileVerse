  ...
  return (
    <div className="tool-page" style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem' }}>
      ...
      <p style={{ marginTop: '1rem', color: '#666' }}>
        Extract high-quality MP3 audio tracks from any video file instantly. Powered locally by WebAssembly.
      </p>

      {!isLoaded && (
        <div style={{ padding: '2rem', background: '#fff3cd', color: '#856404', borderRadius: '8px', marginTop: '2rem' }}>
          Loading Audio Extraction Core... Please wait.
        </div>
      )}
      ...
      {!processedAudioUrl ? (
        <>
          ...
          >
            ...
            <span style={{ fontSize: '1rem', color: '#888', display: 'block', marginTop: '1rem' }}>
              {file ? 'Click to change file' : 'or drop Video here (MP4, WebM, MOV)'}
            </span>
            <input 
              id="file-upload" 
              type="file" 
            ...
            <div style={{ marginTop: '2rem', textAlign: 'left', padding: '2rem', border: '1px solid #eee', borderRadius: '8px' }}>
              ...
              >
                ...
                <span style={{ position: 'relative', zIndex: 1 }}>
                  {isProcessing ? `Extracting Audio... ${progress}%` : 'Extract MP3 Audio'}
                </span>
              </button>
            </div>
          )}
        ...
        <div style={{ padding: '3rem', border: '1px solid #e0e0e0', borderRadius: '12px', marginTop: '2rem', textAlign: 'center' }}>
          <h2>Audio Extracted Successfully!</h2>
          
          <div style={{ marginTop: '2rem', marginBottom: '2rem', display: 'flex', justifyContent: 'center' }}>
            <audio controls src={processedAudioUrl} style={{ width: '100%', maxWidth: '400px' }}></audio>
          </div>
